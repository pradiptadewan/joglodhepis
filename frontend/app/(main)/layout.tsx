            ...
            <div className="text-center">
              ...
              <div className="space-y-4">
                ...
                >
                  ...
                  <span className="group-hover:underline underline-offset-4">0858 0126 2682</span>
                </a>

                <a 
                  href="mailto:joglodhepis1@gmail.com" 
                  className="block text-gray-400 transition-all duration-300 group hover:text-[#BFA06D]"
                >
                  <span className="block text-xs text-gray-500 uppercase tracking-widest mb-1 group-hover:text-white transition-colors">Email</span>
                  <span className="group-hover:underline underline-offset-4">joglodhepis1@gmail.com</span>
                </a>
              </div>
            </div>
