      ...
      <div className="relative h-[60vh] lg:h-[70vh]">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-white px-6 text-center">
            <motion.div initial={{ y: 20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} className="mb-4">
                <span className="uppercase tracking-[0.3em] text-xs md:text-sm font-bold border border-[#BFA06D]/50 px-4 py-2 rounded-full bg-black/20 backdrop-blur-sm text-[#BFA06D]">
                  VW Safari Experience
                </span>
            </motion.div>
